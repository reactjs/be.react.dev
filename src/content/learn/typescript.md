...
Калі працуеце з падзеямі DOM у React, тып падзеі можа быць аўтаматычна вызначаны з апрацоўшчыка. Але ж, калі вы хочаце вынесці функцыю-апрацоўшчык вонкі, вам давядзецца відавочна ўказаць тып падзеі.
