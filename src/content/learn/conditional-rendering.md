...
* Як у залежнасці ад умоў ўключаць або выключаць частку JSX
* Распаўсюджаныя скарачэнні сінтаксісу ўмоўных выразаў, з якімі вы сутыкнецеся ў праектах на React.
...
Вы можаце зрабіць гэта з дапамогай [кіравальнай канструкцыі `if`/`else`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Statements/if...else) такім чынам:
...
У некаторых сітуацыях вам можа патрэбіцца ўвогуле нічога не рэндэрыць. Напрыклад, вы наогул не хочаце паказваць спакаваныя рэчы. Але кампанент павінен нешта вяртаць. У гэтым выпадку вы можаце вярнуць `null`:
...
Абедзве галіны вяртаюцць `<li className="item">...</li>`:
...
* Скарачэнні часта выкарыстоўваюцца, але вы не абавязаны выкарыстоўваць іх, калі аддаеце перавагу простаму `if`.
...
Тут інфармацыя аб кожным напоі згрупавана разам, а не раскідана па некалькіх умовах. Гэта палягчае даданне новых напояў у будучыні.
