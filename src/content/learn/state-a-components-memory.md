...
Пры націсканні на кнопку, праграма павінна запытаць імя карыстальніка, а затым адлюстроўваць прывітанне. Вы спрабавалі выкарыстоўваць стан, каб захаваць імя, але па нейкай прычыне ў першы раз паказваецца «Вітаю, !», а пасля кожны раз паказваецца «Вітаю, [name]!» са старым значэннем формы.
