...
* Каб прачытаць пропсы, скарыстайцеся дэструктурызацыйным сінтаксісам: `function Avatar({ person, size })`.
...
* Вы можаце перадаць усе пропсы даччынаму элементу, скарыстаўшыся сінтаксісам разгортвання: `<Avatar {...props} />`. Але не выкарыстоўвайце яго зашмат!
