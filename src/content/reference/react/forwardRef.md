...
У React 19, `forwardRef` болей непатрэбны. Перадавайце `ref` наўпрост праз пропсы.

`forwardRef` будзе састарэлым ужо ад наступнай версіі. Болей чытайце [тут](/blog/2024/04/25/react-19#ref-as-a-prop).
