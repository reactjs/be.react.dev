...
Для пачатку вылучыце ўсе кампаненты і падкампаненты на макеце і дайце ім імёны. Калі вы працуеце з дызайнерам, то магчыма, што ён ўжо неяк назваў гэтыя кампаненты. Спытайцеся ў яго!
